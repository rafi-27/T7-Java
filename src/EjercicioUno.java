...
//        System.out.println(primeraCadena.replace("prueva", "prueba"));
        ...
        String pasar = String.valueOf(primeraCadena);
        String longi = String.valueOf(pasar.length());
        if(longi.charAt(0) != longi.charAt(-1)){
            System.out.println("Si som iguales");
        }else {
            System.out.println("Na que ver");
        }
